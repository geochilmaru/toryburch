...
# class TorySpider(InitSpider):
    name = "toryburch"
    allowed_domains = ["toryburch.com", "coachoutletstores.us", "github.com"]
    ...
    def login(self, response):
        ...
        return FormRequest.from_response(response,
                                         formdata={'login': 'geochilmaru', 'password': 'tkdghk!220'},
    ...
    def initialized(self):
        print "initialized"
        return Request(url=self.start_urls, callback=self.parse_tory)

    def parse_coach(self, response):
        print "coach"

    def parse_tory(self, response):
        print "toryburch"

    def parse_temp(self, response):
        print "parse_temp"

    def parse_tory_only(self, response):
